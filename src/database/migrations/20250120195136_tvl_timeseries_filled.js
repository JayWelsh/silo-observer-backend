const { TVL_TIMESERIES_FILLED } = require("../tables");

exports.up = (knex) => knex.schema.createTable(TVL_TIMESERIES_FILLED, table => {
    table.increments();
    ...
    table.decimal("tvl", 65, 30).notNullable();
...
exports.down = knex => knex.schema.dropTable(TVL_TIMESERIES_FILLED);